...
export const getServerSideProps = async () => {
  ...
  await Promise.allSettled([
    queryClient.prefetchQuery(
      ['miners', poolEndpointsConfig.EU_PRIMARY_API, 1],
      minersService.getMinersQueryFn,
    ),
    queryClient.prefetchQuery(
      ['minersInfo', poolEndpointsConfig.EU_PRIMARY_API],
      minersService.getMinersInfoQueryFn,
    ),
  ])
