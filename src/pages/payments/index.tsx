...
export const getServerSideProps = async () => {
  ...
  await Promise.allSettled([
    queryClient.prefetchQuery(
      ['payments', poolEndpointsConfig.EU_PRIMARY_API, 1],
      paymentsService.getPaymentsQueryFn,
    ),
    queryClient.prefetchQuery(
      ['paymentsInfo', poolEndpointsConfig.EU_PRIMARY_API],
      paymentsService.getPaymentsInfoQueryFn,
    ),
  ])
